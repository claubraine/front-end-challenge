...
import BlogNavPage from "./pages/BlogNavPage";
import PostNavPage from "./pages/PostNavPage";
import SobreNavPage from "./pages/SobreNavPage";
  ...
  render() {
    return (
      <Switch>
        ...
        <Route exact path="/blog/:id" component={BlogNavPage} />
        <Route exact path="/post/:slug" component={PostNavPage} />
        <Route exact path="/sobre" component={SobreNavPage} />
